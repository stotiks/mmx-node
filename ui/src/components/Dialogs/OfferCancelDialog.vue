            ...
            <WForm ref="formRef" :data="formData" :default-data="defaultFormData" @submit="handleSubmit">
                <q-toolbar class="bg-primary text-white">
                    <q-toolbar-title class="text-subtitle1">
                        <b>{{ $t("account_offers.revoke") }} — {{ offer.address }}</b>
                    </q-toolbar-title>
                </q-toolbar>
                <q-card-section>
                    <div class="q-gutter-y-sm">
                        <div class="row justify-end q-col-gutter-sm">
                            <TxFeeSelect v-model="formData.feeRatio" class="col-md-4 col-sm-5 col-xs-6" />
                            <TxFeeInput
                                v-model="fee"
                    ...
                    <div class="row">
                        ...
                        <div class="col-11">
                            <div class="row justify-end q-gutter-x-sm">
                                <WToggleConfirmed />
                                <WBtnSubmit :label="$t('account_offers.revoke')" />
...
import { useWalletOfferCancel, useWalletOfferCancelFeeEstimate } from "@/queries/wapi";
const {
    data: fee,
