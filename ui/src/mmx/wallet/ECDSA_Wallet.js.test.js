...
describe("ECDSA_Wallet", async () => {
    ...
    it("createFarmerKey", () => {
        assert.equal(toUpperHex(farmerKey), "022C514E47B3C5015D4118F4FF7E38041431358D4B16CB9654C1ABD28D8E1FD8DC");
    });
    ...
    it("getKeys", async () => {
        ...
        assert.equal(toUpperHex(pubKey), "0344EE96D1B85CAC0F99B7CFA44F39EFFC590BDF51D45099D1F24AA09E5F9AD6E0");
        assert.equal(toUpperHex(privKey), "8E469EDD0D8349C59A4255F86C27B5854A071472FCDD94398E86FDB2D0CCFC9B");
    });
