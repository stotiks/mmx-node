...
describe(`Transaction Extensions`, () => {
    ...
    it("compression #1", () => {
        ...
        test(json);
        // Source size: 1004; compressed: 492; compressedBase64: 656; ratio: 204%; ratioB64: 153%
        // Source size: 1004; compressed: 443; compressedBase64: 591; ratio: 227%; ratioB64: 170%
    });
    ...
    it("compression #2", () => {
        ...
        test(json);
        // Source size: 1153; compressed: 445; compressedBase64: 594; ratio: 259%; ratioB64: 194%
        // Source size: 1153; compressed: 398; compressedBase64: 531; ratio: 290%; ratioB64: 217%
    });
});
