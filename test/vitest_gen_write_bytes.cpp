...
template<typename T>
void static print_test(const std::string& testname, const T& value, const std::string& jsvalue, const int version) {
	...
	const auto test =
		"it(\"" + testname + " {v" + std::to_string(version) + "}\", () => {\n"
		"   const wb = new WriteBytes(" + std::to_string(version) + ");\n"
...
void run_tests(const int version)
{

	{
		...
		print_test(testname, value, jsvalue, version);
	}
	...
	{
		const auto testname = "Variant int64_t";
		constexpr int64_t value0 = 1337;
		const vnx::Variant value(value0);
		const std::string jsvalue = "new Variant(" + std::to_string(value0) + "n)";
		print_test(testname, value, jsvalue, version);
	}

	{
		const auto testname = "Variant int64_t min";
		constexpr int64_t value0 = std::numeric_limits<int64_t>::min();
		const vnx::Variant value(value0);
		const std::string jsvalue = "new Variant(" + std::to_string(value0) + "n)";
		print_test(testname, value, jsvalue, version);
	}
	...
	{
		const auto testname = "Variant int64_t max";
		constexpr int64_t value0 = std::numeric_limits<int64_t>::max();
		const vnx::Variant value(value0);
		const std::string jsvalue = "new Variant(" + std::to_string(value0) + "n)";
		print_test(testname, value, jsvalue, version);
	}
	{
		const auto testname = "Variant uint64_t";
		constexpr uint64_t value0 = 1337;
		const vnx::Variant value(value0);
		const std::string jsvalue = "new Variant(" + std::to_string(value0) + "n)";
		print_test(testname, value, jsvalue, version);
	}
	...
	{
		const auto testname = "Variant uint64_t min";
		constexpr uint64_t value0 = std::numeric_limits<uint64_t>::min();
		const vnx::Variant value(value0);
		const std::string jsvalue = "new Variant(" + std::to_string(value0) + "n)";
		print_test(testname, value, jsvalue, version);
	}
	...
	{
		const auto testname = "Variant uint64_t max";
		constexpr uint64_t value0 = std::numeric_limits<uint64_t>::max();
		const vnx::Variant value(value0);
		const std::string jsvalue = "new Variant(" + std::to_string(value0) + "n)";
		print_test(testname, value, jsvalue, version);
	}
